...
NCountry = {
	...
	BASE_MAX_COMMAND_POWER = 500.0,					-- base value for maximum command power
...
NRailwayGun = {
	...
	DISTRIBUTION_DISTANCE_SCORE = -0.05,							-- Score for distance to province when distributing Railway Guns
